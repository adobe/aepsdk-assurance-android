...
public class AssuranceSharedStateTest {
	...
	@Mock
	private Application mockAppplication;

	@Mock
	private SharedPreferences mockSharedPreferences;

	@Mock
	private SharedPreferences.Editor mockPreferenceEditor;
	...
	public void test_Init_nullSharedPreferences() {
		// Prepare
		when(mockAppplication.getSharedPreferences(AssuranceConstants.DataStoreKeys.DATASTORE_NAME,
	...
	public void test_Init_validSharedPreferences() {
		// Prepare
		when(mockAppplication.getSharedPreferences(AssuranceConstants.DataStoreKeys.DATASTORE_NAME,
				Context.MODE_PRIVATE)).thenReturn(mockSharedPreferences);
		...
		verify(mockPreferenceEditor).putString(AssuranceConstants.DataStoreKeys.CLIENT_ID, "sampleClientID");
		verify(mockPreferenceEditor).putString(AssuranceConstants.DataStoreKeys.SESSION_ID, "sampleSessionID");
	}
	...
	public void test_Init_emptyPersistedClientId() {
		...
		Assert.assertNotNull(assuranceSharedState.getClientId());
		Assert.assertEquals("sampleSessionID", assuranceSharedState.getSessionId());
		verify(mockPreferenceEditor).putString(AssuranceConstants.DataStoreKeys.CLIENT_ID, assuranceSharedState.getClientId());
		verify(mockPreferenceEditor).putString(AssuranceConstants.DataStoreKeys.SESSION_ID, "sampleSessionID");
	}
	...
	public void test_setSessionId_nonNullSessionId() {
		...
		// Verify
		verify(mockPreferenceEditor).putString(AssuranceConstants.DataStoreKeys.SESSION_ID, "aNewSessionId");
