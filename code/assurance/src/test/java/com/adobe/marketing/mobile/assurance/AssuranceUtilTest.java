...
public class AssuranceUtilTest {
	...
	public void test_getURLFormatForEnvironment() {
		assertEquals("", AssuranceUtil.getURLFormatForEnvironment(AssuranceConstants.AssuranceEnvironment.PROD));
		assertEquals("-stage", AssuranceUtil.getURLFormatForEnvironment(AssuranceConstants.AssuranceEnvironment.STAGE));
		assertEquals("-qa", AssuranceUtil.getURLFormatForEnvironment(AssuranceConstants.AssuranceEnvironment.QA));
		assertEquals("-dev", AssuranceUtil.getURLFormatForEnvironment(AssuranceConstants.AssuranceEnvironment.DEV));
	}

	@Test
	public void test_getEnvironmentFromQueryValue_whenNullOrEmpty() {
		assertEquals(AssuranceConstants.AssuranceEnvironment.PROD, AssuranceUtil.getEnvironmentFromQueryValue(null));
		assertEquals(AssuranceConstants.AssuranceEnvironment.PROD, AssuranceUtil.getEnvironmentFromQueryValue(""));
	}

	@Test
	public void test_getEnvironmentFromQueryValue() {
		assertEquals(AssuranceConstants.AssuranceEnvironment.PROD, AssuranceUtil.getEnvironmentFromQueryValue("prod"));
		assertEquals(AssuranceConstants.AssuranceEnvironment.STAGE, AssuranceUtil.getEnvironmentFromQueryValue("stage"));
		assertEquals(AssuranceConstants.AssuranceEnvironment.QA, AssuranceUtil.getEnvironmentFromQueryValue("qa"));
		assertEquals(AssuranceConstants.AssuranceEnvironment.DEV, AssuranceUtil.getEnvironmentFromQueryValue("dev"));
		assertEquals(AssuranceConstants.AssuranceEnvironment.PROD, AssuranceUtil.getEnvironmentFromQueryValue("randomString"));
	}

	@Test
	public void test_getValidSessionIDFromUri() {
		assertEquals("2a22cbdc-d705-4f1a-88b3-b73f7fe67a4e",
				AssuranceUtil.getValidSessionIDFromUri(
						Uri.parse("baseball://?adb_validation_sessionid=2a22cbdc-d705-4f1a-88b3-b73f7fe67a4e")));
		assertNull(AssuranceUtil.getValidSessionIDFromUri(
				Uri.parse("baseball://?adb_validation_sessionid=2-22cbdc-d705-4f1a-88b3-b73f7fe67a4e")));
		assertNull(AssuranceUtil.getValidSessionIDFromUri(
				Uri.parse("baseball://?wrongKey=2a22cbdc-d705-4f1a-88b3-b73f7fe67a4e")));
		assertNull(AssuranceUtil.getValidSessionIDFromUri(
				Uri.parse("baseball://?adb_validation_sessionid=2a22cbdc-d705-4f1a-88b3-b73f7fe67a4e2a22cbdc-d705-4f1a-88b3-b73f7fe67a4e")));
		assertNull(AssuranceUtil.getValidSessionIDFromUri(
				Uri.parse("baseball://?adb_validation_sessionid=2a22cbdcd7054f1a88b3b73f7fe67a4e")));
