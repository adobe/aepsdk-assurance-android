...
public class AssuranceErrorDisplayActivity extends AppCompatActivity {
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		if (btnDismiss != null) {
			...
			Log.warning(Assurance.LOG_TAG, LOG_TAG, "Unable to retrieve the instance of the dismiss button.");
		}
		...
		if (intent == null) {
			Log.warning(Assurance.LOG_TAG, LOG_TAG, "Unable to show AssuranceErrorDisplayActivity, Intent is null");
			return;
		}

		final String errorName = intent.getStringExtra(AssuranceConstants.IntentExtraKey.ERROR_NAME);
		final String errorDescription = intent.getStringExtra(AssuranceConstants.IntentExtraKey.ERROR_DESCRIPTION);
