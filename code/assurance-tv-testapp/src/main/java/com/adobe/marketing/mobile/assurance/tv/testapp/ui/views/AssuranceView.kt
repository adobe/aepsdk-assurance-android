...
internal fun AssuranceScreen(
    ...
    Box(modifier = Modifier.testTag(AssuranceTvTestAppConstants.TEST_TAG_ASSURANCE_SCREEN)) {
        Column(
            modifier = Modifier
                .fillMaxWidth()
                .padding(8.dp)
...
private fun AppIdConfiguration() {
    ...
    Column {
        TextField(
            ...
            modifier = Modifier
                .fillMaxWidth()
                .testTag(AssuranceTvTestAppConstants.TEST_TAG_APP_ID_INPUT)
        )
        ...
        Button(
            ...
            modifier = Modifier
                .fillMaxWidth()
                .testTag(AssuranceTvTestAppConstants.TEST_TAG_CONFIGURE_WITH_APP_ID_BUTTON)
        ) {
        ...
        Row(horizontalArrangement = Arrangement.SpaceEvenly) {
                ...
                onClick = {
                    scope.launch {
                        assuranceTestAppViewModel.sendEvent(
                            AssuranceTvTestAppConstants.SMALL_EVENT_PAYLOAD_FILE
                        )
                    }
                },
            ...
            Button(
                onClick = {
                    scope.launch {
                        assuranceTestAppViewModel.sendEvent(
                            AssuranceTvTestAppConstants.LARGE_EVENT_PAYLOAD_FILE
                        )
                    }
                },
                modifier = Modifier.padding(4.dp)
        ...
        Row(horizontalArrangement = Arrangement.SpaceAround) {
            Button(
                onClick = {
                    scope.launch {
                        assuranceTestAppViewModel.sendEvent(
                            AssuranceTvTestAppConstants.LARGE_HTML_PAYLOAD_FILE
                        )
                    }
                },
                modifier = Modifier.padding(4.dp)
