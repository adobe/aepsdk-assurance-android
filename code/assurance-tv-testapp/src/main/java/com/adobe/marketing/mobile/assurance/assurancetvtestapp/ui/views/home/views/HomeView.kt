...
package com.adobe.marketing.mobile.assurance.assurancetvtestapp.ui.views.home.views
...
import com.adobe.marketing.mobile.assurance.assurancetvtestapp.AssuranceTvTestAppConstants
import com.adobe.marketing.mobile.assurance.assurancetvtestapp.ui.views.videos.model.Video
import com.adobe.marketing.mobile.assurance.assurancetvtestapp.sendEvent
...
fun HomeView(
    ...
    if (isLoading) {
        ...
        // Log error instead of showing ErrorView UI
        Log.e("HomeView", "Error in HomeView: $error")
        Box(
            modifier = Modifier.fillMaxSize(),
            contentAlignment = Alignment.Center
        ) {
