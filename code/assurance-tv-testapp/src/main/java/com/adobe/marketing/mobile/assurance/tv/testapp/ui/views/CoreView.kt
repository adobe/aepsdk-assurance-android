...
import com.adobe.marketing.mobile.assurance.tv.testapp.AssuranceTvTestAppConstants
import com.adobe.marketing.mobile.assurance.tv.testapp.R

@Composable
internal fun CoreScreen() {
    Column(modifier = Modifier.testTag(AssuranceTvTestAppConstants.TEST_TAG_CORE_SCREEN)) {
...
private fun EventSection() {
    Column(modifier = Modifier.testTag(AssuranceTvTestAppConstants.TEST_TAG_EVENTS_SECTION)) {
        Row(
            Modifier
                .align(Alignment.CenterHorizontally)
                .padding(16.dp)
            ...
            Text(
                ...
                fontSize = 18.sp,
                textDecoration = TextDecoration.Underline,
                modifier = Modifier.padding(8.dp).testTag(AssuranceTvTestAppConstants.TEST_TAG_TRACK_ACTION_BUTTON)
            )
        }
            ...
            Button(
                onClick = {
                    MobileCore.trackAction(
                        AssuranceTvTestAppConstants.TRACK_ACTION_NAME,
            ...
            Button(
                onClick = {
                    MobileCore.trackState(
                        AssuranceTvTestAppConstants.TRACK_STATE_NAME,
                        mapOf("sampleKey" to "sampleValue")
                    )
                },
                modifier = Modifier.padding(8.dp).testTag(AssuranceTvTestAppConstants.TEST_TAG_TRACK_STATE_BUTTON)
            ) {
            ...
            Button(
                onClick = {
                    MobileCore.dispatchEvent(
                        Event.Builder(
                            AssuranceTvTestAppConstants.TEST_EVENT_NAME,
                            AssuranceTvTestAppConstants.TEST_EVENT_TYPE,
                            AssuranceTvTestAppConstants.TEST_EVENT_SOURCE
                        )
                            .setEventData(mapOf("sampleKey" to "sampleValue"))
                            .build()
                    )
                },
                modifier = Modifier.padding(8.dp).testTag(AssuranceTvTestAppConstants.TEST_TAG_DISPATCH_EVENT_BUTTON)
            ) {
